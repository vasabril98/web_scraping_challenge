...
1. Use automated browsing to visit the [Mars news sit] (https://static.bc-edx.com/data/web/mars_news/index.html). Inspect the page to identify which elements to scrape.
